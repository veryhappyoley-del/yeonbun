{{--
  ...
  구성:
  1. 전역 헤더
  2. 히어로 — 큰 슬로건 + 단일 CTA("/sagu"로 유도, 종목은 거기서 고르게 함)
  3. "왜 결인가요" — 실제로 만든 기능만 정직하게 3가지(report-trust-grid 재사용,
     reports.js의 결제 전 신뢰 배지와 같은 시각 언어)
  4. "무엇을 볼 수 있나요" — 종목 미리보기 카드 3개(sagu-card 재사용) + "/sagu" 전체보기 링크
  5. 비즈니스 푸터 + 하단 탭바
...
<div class="wrap">
  ...
  {{-- (2026-08-25 5차 수정) 처음엔 report-trust-grid(결제 CTA 아래 붙는 작은 신뢰 배지용
       ...
       처리 방식), 카드 padding과 글자 크기를 키우고, 상단에 영문 킥커(WHY 결)+한 줄
       소개문을 추가해서 섹션 전체가 더 격식 있어 보이게 했다. --}}
  <div class="card">
    <div class="home-feature-kicker">WHY 결</div>
    <h2>왜 결인가요</h2>
    <p class="home-feature-intro">다른 사주 서비스와는 이런 점이 달라요.</p>
