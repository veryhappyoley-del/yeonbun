  ...
  <div class="card">
      ...
      <div style="overflow-x:auto;">
        <table class="policy-table">
          ...
          <tbody>
            ...
            <tr>
              <td>오늘의 운세 구독</td>
              <td>구독을 위해 저장한 생년월일시·별칭·성별, 정기결제를 위한 토스페이먼츠
                고객식별키(billingKey는 회사가 아닌 토스페이먼츠가 보관)</td>
              <td>구독 신청 화면에 직접 입력, 매달 자동결제 시 토스페이먼츠로부터 결제 결과 수신</td>
            </tr>
            <tr>
              <td>결제 정보</td>
    ...
    <div class="policy-section">
      ...
      <ul>
        ...
        <li>오늘의 운세 구독을 위해 저장한 생년월일시 등 정보 : 재구독 시 다시 입력하지 않도록 회원 탈퇴 전까지 보관하며(구독을 해지해도 정보 자체는 남아있음), 탈퇴 시 파기</li>
      </ul>
    </div>
    ...
    <div class="policy-section">
      ...
      <ul>
        ...
        <li><strong>토스페이먼츠</strong> — 코인 충전·리포트 결제 및 오늘의 운세 정기결제(자동결제)의 승인 및 처리</li>
